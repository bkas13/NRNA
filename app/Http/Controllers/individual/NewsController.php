...
class NewsController extends Controller
{
    ...
    {
        $userId = Auth::id();
        $news = $this->news->getNewsByRegion($userId);
        return view('individual.news.index', compact('news'));
    }
    public function add()
    {
        return view('individual.news.add');
    }
    public function addSubmit(NewsRequest $request)
    {
        try {
            ...
            if ($saveNews) {
                ...
                return redirect()->route('individual.news.all');
            } else {
    ...
    public function edit($slug)
    {
        ...
        return view('individual.news.edit', compact('news'));
    }
