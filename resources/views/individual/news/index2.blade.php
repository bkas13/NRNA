            ...
            <div class="widget-content widget-content-area br-6">
                <div class="___class_+?3___">
                    <div id="multi-column-ordering_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h3 class="___class____">News Management</h3>
                            </div>
                            <div class="col-md-6 text-md-right">
                                <a href="{{ route('admin.news.add') }}" type="button"
                                    class="btn btn-primary btn-rounded mb-2 ">Add News</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <tbody>
                                        @foreach ($news as $singleNews)
                                            <tr role="row">
                                                    ...
                                                    <div class="d-flex">
                                                        {{-- <div class="usr-img-frame mr-2 rounded-circle">
                                                            <img alt="avatar" class="img-fluid rounded-circle"
                                                                src="{{ getMediaUrl($news->profileImage->path ?? 'panel/assets/img/90x90.jpg') }}">
                                                        </div> --}}
                                                ...
                                                {{-- <td>{{ $singleNews->email }}</td> --}}
                                                {{-- <td>{{ $singleNews->phone }}</td> --}}
                                                <td class="text-center">
                                                    <a href="{{ route('admin.news.edit', $singleNews->slug) }}"
                                                        type="button" class="btn btn-primary btn-rounded p-2">
                                                        <i class="fa fa-edit"></i></a>

                                                    <a href="{{ route('admin.news.delete', $singleNews->slug) }}"
                                                        type="button" class="btn btn-danger btn-rounded p-2">
