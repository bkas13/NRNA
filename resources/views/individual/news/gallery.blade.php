...
@push('scripts')
    ...
    <script>
        ...
        function get_images() {
            ...
            $.ajax({
                ...
                url: '{{ route("individual.news.get_images", $singleNews->id) }}',
                contentType: false,
                processData: false,
                method: 'get',
                // data: formData,
    ...
    <script>
        $('#image_submit').on('change', function() {
            ...
            $.ajax({
                ...
                url: '{{ route("individual.news.upload_gallery", $singleNews->id) }}',
                contentType: false,
                processData: false,
                method: 'POST',
                data: formData,
    ...
    <script>
        jQuery(document).on('click', '.delete_document', function(e) {
            ...
            var url = '{{ route("individual.news.delete_gallery", ':imageId') }}';
