...
@section('content')
    <div class="row">
        <div class="col-12">
            <form action="{{ route('region.addRegionSiteSetting') }}" method="POST" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="form-row mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-4 col-md-8">
                                    <div class="custom-file-container " data-upload-id="featureID">
                                        <label>Featured Image (In <a target="_blank" href="{{url('/')}}">Homepage</a>) <a href="javascript:void(0)"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group mt-2">
                                    <label for="delegate">Delegates URL</label>
                                    <input type="text" name="delegate_url" placeholder="Enter Delegate Url.." class="form-control"
                                        value="{{ old('delegate_url', $settingsData['delegate_url'] ?? '') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card mb-3 mt-2">
                    <div class="card-body">
                        <div class="form-row mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mt-2">
                                    <label for="subtitleb">Short About (displayed in home)</label>
                                    <textarea name="brief_about" class="form-control"
                                        rows="10">{{ old('brief_about', $settingsData['brief_about'] ?? '') }}</textarea>
                                    @error('brief_about')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group mt-2">
                                    <label for="subtitle">About Page</label>
                                    <textarea name="about"
...
@push('scripts')
    ...
    <script>
        ...
        //feature_logo upload
        @if ($settingsImages->feature_image)
            var importedLogoImage="{{ getMediaUrl($settingsImages->feature_image->path) }}";
            var firstUpload= new FileUploadWithPreview('featureID',{
            images:{
            baseImage:importedLogoImage,
            },
            });
