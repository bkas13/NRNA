            ...
            <div class="widget-content widget-content-area br-6">
                <div class="___class_+?3___">
                    <div id="multi-column-ordering_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-md-right"> <a href="{{ route('region.settings.bannerAdd') }}"
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                ...
                                <td class="text-center">
                                    ...
                                    <a href="{{ route('region.settings.bannerEdit', $banner->id) }}" type="button"
                                    ...
                                    <a href="{{ route('region.settings.bannerDestroy', $banner->id) }}" type="button"
