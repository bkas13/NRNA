            ...
            <div class="widget-content widget-content-area br-6">
                <div class="___class_+?3___">
                    <div id="multi-column-ordering_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-md-right"> <a href="{{ route('region.news.add') }}" type="button"
                            ...
                            <tbody>
                                @foreach ($news as $singleNews)
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ isset($singleNews->featureImage) ? getMediaUrl($singleNews->featureImage->path) : ' ' }}"
                                ...
                                <td>
                                    <a href="{{ route('region.news.gallery', $singleNews->slug) }}"
                                        class="btn btn-success btn-icon-text p-1" title="Manage Gallery">
                                        <i class="fa fa-image fa-2x"></i>
                                    </a>
                                    <a href="{{ route('region.news.edit', $singleNews->slug) }}"
                                    ...
                                    <a href="{{ route('region.news.delete', $singleNews->slug) }}"
