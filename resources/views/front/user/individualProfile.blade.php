    ...
    <div class="main_content">
        <div class="container">
            <div class="candidate_page">
                ...
                background-image: url('{{getMediaUrl($candidateImages->profileBannerImage->path ??"front/images/banner.jpg")}}');
                ...
                <div class="candidate_page_lower_banner">
                    <div class="candidate_page_lower_banner_wrapper">
                        <div class="img_container">
                            <img src="{{getMediaUrl($candidateImages->profileImage->path ?? 'front/images/candidate1.png')}}" alt="" />
                        </div>
                        <div class="candidate_name">{{$currentUser->name}}</div>
                    ...
                    <div class="candidate_page_sidebar">
                        <ul class="contact_list">
                            ...
                            <li>
                                ...
                                <span class="contact_list_item">{{$candidateData['phone'] ?? ''}}</span>
                            </li>
                            <li>
                                <i class="fa fa-envelope"></i>
                                <span class="contact_list_item">{{$candidateData['email'] ?? ''}}</span>
                            </li>
                        </ul>
                                ...
                                @foreach($recentNews as $news)
                                    <a href="{{route('front.singleNews',[$currentUser->username, $news->slug])}}" class="recent_events_item">
                                        <div class="img_wrapper">
                                            <img src="{{asset($news->featureImage->path ?? 'front/images/news1.jpg')}}" alt="" />
                                        </div>
