            ...
            <div class="widget-content widget-content-area br-6">
                <div class="___class_+?3___">
                    <div id="multi-column-ordering_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-md-right"> <a href="{{ route('admin.settings.bannerAdd') }}"
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap"
                            ...
                            <tbody>
                                ...
                                <td class="text-center">
                                    {{-- <a href="{{ route('admin.settings.viewBanner', $banner->id) }}"
                                        class="btn btn-success btn-icon-text p-1" title="View Banner Details">
                                        <i class="fa fa-image fa-2x"></i>
                                    </a> --}}
                                    <a href="{{ route('admin.settings.bannerEdit', $banner->id) }}" type="button"
                                        class="btn btn-primary btn-rounded p-2"> <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <a href="{{ route('admin.settings.bannerDestroy', $banner->id) }}" type="button"
